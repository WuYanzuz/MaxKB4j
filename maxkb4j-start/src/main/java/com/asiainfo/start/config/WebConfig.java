package com.asiainfo.start.config;

import com.asiainfo.core.interceptor.AuthInterceptor;
...
/*    @Override
    ...
    public void addViewControllers(@NotNull ViewControllerRegistry registry) {
        ...
        registry.addViewController("/chat/batch-eval").setViewName("forward:/chat/batch-eval.html");
