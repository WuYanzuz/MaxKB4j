...
import com.asiainfo.common.constant.ResourceType;
import com.asiainfo.common.constant.RoleType;
import com.asiainfo.common.domain.form.BaseField;
import com.asiainfo.common.domain.form.LocalFileUpload;
import com.asiainfo.common.domain.form.TextInputField;
import com.asiainfo.common.util.BeanUtil;
import com.asiainfo.common.util.DateTimeUtil;
import com.asiainfo.common.util.StpKit;
import com.asiainfo.core.event.CreateWebDocsEvent;
import com.asiainfo.core.event.GenerateProblemEvent;
import com.asiainfo.knowledge.dto.GenerateProblemDTO;
import com.asiainfo.knowledge.dto.KnowledgeQuery;
import com.asiainfo.knowledge.dto.WebKnowledgeDTO;
import com.asiainfo.knowledge.entity.*;
import com.asiainfo.knowledge.handler.KnowledgeExportHandler;
import com.asiainfo.knowledge.mapper.KnowledgeMapper;
import com.asiainfo.knowledge.mapper.ParagraphMapper;
import com.asiainfo.knowledge.mapper.ProblemMapper;
import com.asiainfo.knowledge.mapper.ProblemParagraphMapper;
import com.asiainfo.knowledge.store.IDataStore;
import com.asiainfo.knowledge.vo.KnowledgeListVO;
import com.asiainfo.knowledge.vo.KnowledgeVO;
import com.asiainfo.system.constant.AuthTargetType;
import com.asiainfo.system.entity.TargetResource;
import com.asiainfo.system.service.IResourceMappingService;
import com.asiainfo.user.service.IUserResourcePermissionService;
import com.asiainfo.user.service.IUserService;
import com.asiainfo.workflow.builder.NodeBuilder;
import com.asiainfo.workflow.logic.LogicFlow;
import com.asiainfo.workflow.model.KnowledgeParams;
...
public class KnowledgeService extends ServiceImpl<KnowledgeMapper, KnowledgeEntity> implements IKnowledgeService {
    ...
    public List<BaseField> datasourceFormList(String nodeType, JSONObject params) {
        if (DATA_SOURCE_WEB.getKey().equals(nodeType)) {
            ...
            BaseField localFileUpload = new LocalFileUpload(50, 100, List.of("TXT", "ADOC", "DOCX", "PDF", "HTML", "XLS", "XLSX", "CSV"));
            if (params == null) {
