...
import com.asiainfo.common.constant.Operate;
...
public enum PermissionEnum {
    ...
    APPLICATION_BATCH_DELETE(ResourceType.APPLICATION, "APPLICATION", Operate.BATCH_DELETE, Permission.MANAGE),
    ...
    KNOWLEDGE_BATCH_DELETE(ResourceType.KNOWLEDGE, "KNOWLEDGE", Operate.BATCH_DELETE, Permission.MANAGE),
    ...
    TOOL_BATCH_DELETE(ResourceType.TOOL, "TOOL", Operate.BATCH_DELETE, Permission.MANAGE),
